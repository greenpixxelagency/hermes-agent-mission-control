-- CreateEnum
CREATE TYPE "OrganizationRole" AS ENUM ('OWNER', 'ADMIN', 'OPERATOR', 'APPROVER', 'VIEWER');

-- CreateEnum
CREATE TYPE "ProjectRole" AS ENUM ('OWNER', 'ADMIN', 'OPERATOR', 'APPROVER', 'VIEWER');
...
-- CreateIndex
CREATE INDEX "ProjectMember_organizationMemberId_idx" ON "ProjectMember"("organizationMemberId");
