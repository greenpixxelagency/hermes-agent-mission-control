...
export async function recordAuditEvent(input: { projectId: string; eventType: string; actor: AuditActor; targetType: string; targetId?: string; taskId?: string; approvalRequestId?: string; projectToolId?: string; summary: string; metadata?: unknown }, db: Prisma.TransactionClient | typeof prisma = prisma) {
