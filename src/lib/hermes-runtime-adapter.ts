...
export const hermesRuntimeAdapter: HermesRuntimeAdapter = {
  ...
  ensureBot: spec => request('/bots/ensure', { method: 'POST', body: JSON.stringify({ projectKey: spec.projectKey, runtimeProfileKey: spec.profileId, employeeKey: spec.employeeKey }) }),
